          ...
          <div className="w-full max-w-md rounded-2xl border-2 border-destructive/20 bg-card p-8 shadow-2xl animate-in fade-in zoom-in-95 duration-200">
            ...
            <div className="grid grid-cols-2 gap-4">
              <button
                ...
                autoFocus
                className="py-3 px-4 text-sm font-bold rounded-xl border-2 border-border hover:bg-muted transition-all focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 outline-none"
              >
                Abbrechen
              </button>
              <button
                ...
                className="py-3 px-4 text-sm font-black rounded-xl bg-destructive text-white shadow-lg shadow-destructive/20 hover:bg-destructive/90 transition-all focus-visible:ring-2 focus-visible:ring-destructive focus-visible:ring-offset-2 outline-none"
              >
                Endgültig löschen
              </button>
            </div>
