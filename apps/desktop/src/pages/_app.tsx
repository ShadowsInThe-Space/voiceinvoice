...
export default function App({ Component, pageProps }: AppProps): React.ReactElement {
  ...
  return (
    <div className="min-h-screen bg-gray-100 dark:bg-gray-900">
      ...
      <div role="status" aria-label="Navigation Status" aria-live="polite" className="sr-only">
        {navStatus}
      </div>
      ...
      <header
        role="banner"
        className="fixed top-0 left-0 right-0 z-40 bg-white dark:bg-gray-800 shadow-sm"
      >
      ...
      {/* Main content area */}
      <main id="main-content" role="main" className="pt-16 md:ml-64 min-h-screen">
        <div className="p-6">
          <Component {...pageProps} />
        </div>
      </main>
