...
describe('InvoiceList', () => {
  ...
  describe('deletion', () => {
    it('should render delete button when onDelete is provided', () => {
      ...
      const deleteButtons = screen.getAllByRole('button', { name: /loeschen|löschen|delete/i });
    ...
    it('should not render delete button when onDelete is not provided', () => {
      ...
      expect(screen.queryByRole('button', { name: /loeschen|löschen|delete/i })).not.toBeInTheDocument();
    });
    ...
    it('should call onDelete with invoice id when delete is clicked', async () => {
      ...
      const row = screen.getByTestId('invoice-row-inv-2');
      const deleteButton = within(row).getByRole('button', { name: /loeschen|löschen|delete/i });
