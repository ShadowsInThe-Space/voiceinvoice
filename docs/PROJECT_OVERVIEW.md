...
1.  **Spracheingabe**:
    ...
    *   Er spricht natürlich: *"Erstelle eine Rechnung für Max Mustermann über 500 Euro für das Webdesign-Projekt im Januar."*
...
3.  **Privacy Layer 2 (Client-Side)**: Ein "Fuzzy Masking Filter" im Client anonymisiert Kundennamen *bevor* der Text weiterverarbeitet wird (z.B. wird "Max Mustermann" zu `[KUNDE#123]`).
