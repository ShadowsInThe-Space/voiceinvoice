...
1. **Google Gemini API**
   - API Key: `AIzaSyAhM6S1SWtsMoKptlsxhYr84lWNgSep8fE`

2. **Google OAuth2**
   - Client ID: `13993611510-fs2a30rbkr3v27nbp1lkttbrf890tjku.apps.googleusercontent.com`
   - Client Secret: `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`
   - Scopes: (siehe ops/n8n/google-oauth2-scopes.txt)

3. **Slack API**
   - Access Token: `xoxb-10366001135798-10366768418246-ItL7BRYXzyhSCuab2YeEb6Nx`
